     ...
     <div className="lg:px-10 py-24">
        <div id="cardSection" className="px-4 lg:mx-16">
           ...
           {roleProfile == "Master Auditor" && data.status == "Hold" && (
              <div className="mx-auto my-2 text-center text-xl w-3/4 bg-blue-100 shadow-md rounded-lg p-5">
                 <h1><span className="underline text-[#0f6990] font-semibold">Hold Description:</span> {reviewData[0].description}</h1>
              </div>
           )}
